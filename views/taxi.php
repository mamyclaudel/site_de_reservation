...
<nav class="navbar navbar-expand-sm navbar-dark bg-primary">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <button class="btn btn-light btn-block m-2" ><a href="./hebergement.php"><img src="../publics/images/lit.png" alt="" style="height:20px; margin-right: 2px;">Hebergements</a></button>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <button class="btn btn-light btn-block m-2"  style="padding-left:40px; padding-right: 40px;"><a href="#"><img src="../publics/images/taxi.png" alt="" style="height:20px; margin-right: 2px;">Taxi</a></button>
            </li>
            <li class="nav-item">
